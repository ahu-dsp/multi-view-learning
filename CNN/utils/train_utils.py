    ...
    def train(self):
        ...
        for epoch in range(self.start_epoch, args.max_epoch):
            ...
            for phase in ['train', 'val']:
                ...
                trainning_time.append(time.time()-epoch_start)
                # save the model
                if phase == 'val':
                    ...
                    if epoch_acc > best_acc or epoch > args.max_epoch-2:
                        best_acc = epoch_acc
                        pdict = {'pred_label': np.array(pred)}
                        tdict = {'true_label': np.array(labels)}
        ...
        print('all train time：{}(s/100epoch)'.format(np.array(trainning_time).sum()))
