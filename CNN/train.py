...
def parse_args():
    ...
    parser.add_argument('--data_name', type=str, default='XJTU', help='the name of the data')
    parser.add_argument('--data_dir', type=str, default="data/XJTU", help='the directory of the data')
    ...
    parser.add_argument('--batch_size', type=int, default=80, help='batchsize of the training process')
