...
from datasets._user_functions import Normal_signal, Slide_window_sampling, Add_noise, FFT
from datasets.__construct_graph import generate_graph
...
def data_preprocessing(dataset_path, sample_number, window_size, overlap, normalization, noise, snr,
    ...
    # health = ['n600_3_2.csv']  # 600 800 1000转速下的正常信号
    # inner = ['ib600_2.csv']  # 600 800 1000转速下的内圈故障信号
    # outer = ['ob600_2.csv']  # 600 800 1000转速下的外圈故障信号
    # ball = ['tb600_2.csv']  # 600 800 1000转速下的滚动体故障信号
    ...
    train_data, test_data = train_test_split(graph_dataset, train_size=train_size, shuffle=True,
                                             stratify=str_y_1)  # 训练集、测试集划分
