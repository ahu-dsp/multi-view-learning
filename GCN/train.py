...
def parse_args():
    ...
    # basic parameters
    #===================================================datasets parameters=============================================================================
    parser.add_argument('--dataset_name', type=str, default='JNU', help='the name of the datasets：CWRU、SEU、XJTU、JNU、MFPT、UoC、DC')
    parser.add_argument('--dataset_path', type=str, default="data/JNU", help='the file path of the datasets')
    ...
    parser.add_argument('--graph_type', type=str, default='knn_graph', help='the type of graph')
    ...
    parser.add_argument('--edge_type', type=str, default='Euclidean Distance', help='the edge weight method of graph')
